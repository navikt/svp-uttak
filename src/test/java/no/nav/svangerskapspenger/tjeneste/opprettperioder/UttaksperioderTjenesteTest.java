...
public class UttaksperioderTjenesteTest {
    ...
    public void først_delvis_tilrettelegging_så_full_tilrettelegging_fører_til_to_perioder() {
        var delvisTilrettelegging = new DelvisTilrettelegging(LocalDate.of(2019, Month.JANUARY, 1), BigDecimal.valueOf(50L), BigDecimal.ZERO);
    ...
    public void først_ikke_søkt_deretter_delvis_tilrettelegging_så_full_tilrettelegging_fører_til_tre_perioder() {
        var delvisTilrettelegging = new DelvisTilrettelegging(LocalDate.of(2019, Month.JANUARY, 15), BigDecimal.valueOf(50L), BigDecimal.ZERO);
        var fullTilrettelegging = new FullTilrettelegging(LocalDate.of(2019, Month.FEBRUARY, 1));
        var søknad = new Søknad(
            ARBEIDSFORHOLD1,
            HUNDRE_PROSENT,
    ...
    public void alt_før_behovsdato_fjernes_dersom_det_finnes_en_arbeidsgiversdato_link_behovsdato() {
        ...
        var ingenTilrettelegging = new IngenTilrettelegging(LocalDate.of(2018, Month.DECEMBER, 15));
        var delvisTilrettelegging = new DelvisTilrettelegging(LocalDate.of(2019, Month.JANUARY, 1), new BigDecimal("40.0"), BigDecimal.ZERO);
        var fullTilrettelegging = new FullTilrettelegging(LocalDate.of(2019, Month.FEBRUARY, 1));
        var søknad = new Søknad(
            ARBEIDSFORHOLD1,
            HUNDRE_PROSENT,
    ...
    public void delvis_tilrettelegging_fra_februar_fører_til_to_uttaksperioder() {
        var delvisTilrettelegging = new DelvisTilrettelegging(LocalDate.of(2019, Month.FEBRUARY, 1), BigDecimal.valueOf(20L), BigDecimal.ZERO);
    ...
    public void delvis_tilrettelegging_fra_første_dag_fører_til_en_uttaksperioder() {
        var delvisTilrettelegging = new DelvisTilrettelegging(LocalDate.of(2019, Month.JANUARY, 1), BigDecimal.valueOf(20L), BigDecimal.ZERO);
    ...
    public void delvis_tilrettelegging_for_sent_fører_til_en_uttaksperioder_med_full_utbetaling() {
        var delvisTilrettelegging = new DelvisTilrettelegging(LocalDate.of(2019, Month.MAY, 1), BigDecimal.valueOf(20L), BigDecimal.ZERO);
        var søknad = new Søknad(
            ARBEIDSFORHOLD1,
            HUNDRE_PROSENT,
            TERMINDATO,
